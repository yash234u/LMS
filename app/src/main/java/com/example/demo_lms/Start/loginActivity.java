                ...
                if (username_txt.isEmpty() || pass_txt.isEmpty()) {
                    ...
                    database.child("User_master").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.hasChild(username_txt)) {
                                String getPass = snapshot.child(username_txt).child("Password").getValue().toString();
                                String getEnable = snapshot.child(username_txt).child("Enable").getValue().toString();
                                if (getEnable.equals("Yes")) {
                                    if (getPass.equals(pass_txt)) {
                                        String type = snapshot.child(username_txt).child("Type").getValue().toString();
