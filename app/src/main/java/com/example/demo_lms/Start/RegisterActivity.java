                    ...
                    database.child("Student_master").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            else
                            {
                                ...
                                database.child("User_master").child(Username_txt).child("Password").setValue(Pass_txt);
                                database.child("User_master").child(Username_txt).child("Type").setValue("Student");
                                database.child("User_master").child(Username_txt).child("Enable").setValue("Yes");
